...
void QtAddressBookGUI::createWidgets()
{
    ...
    list->setStyleSheet("color: blue;""font: italic 14px;"
                            "background-color: yellow;"
                            "selection-color: yellow;"
                            "selection-background-color: blue;");
    detailView->setStyleSheet("color: blue;""font: italic 14px;"
                            "background-color: yellow;"
                            "selection-color: yellow;"
                            "selection-background-color: blue;");
    newContactButton = new QPushButton("New Contact");
    newContactButton->setStyleSheet("color: blue;""font: italic 14px;"
                            "background-color: red;"
                            "selection-color: red;"
                            "selection-background-color: blue;");
    editContactButton = new QPushButton("Edit");
    editContactButton->setStyleSheet("color: blue;""font: italic 14px;"
                            "background-color: red;"
                            "selection-color: red;"
                            "selection-background-color: blue;");
    deleteContactButton = new QPushButton("Delete");
    deleteContactButton->setStyleSheet("color: blue;""font: italic 14px;"
                                     "background-color: red;"
                                     "selection-color: red;"
                                     "selection-background-color: blue;");
